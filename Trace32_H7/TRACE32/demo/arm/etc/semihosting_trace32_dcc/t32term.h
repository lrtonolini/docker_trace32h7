/**************************************************************************
	...
	possible defines:
	  ...
	  T32_TERM_METHOD_MEMORY       : provide access by (dual port) access memory methods BUFFERE,BUFFERC,BUFFERS (T32_TERM_BLOCKED) or SINGLEE,SINGLEC,SINGLES
	  T32_TERM_MEMORY_BLOCKED_SIZE : Size of the buffer used by terminal when T32_TERM_BLOCKED is definded. Should not be larger than 15K.
	                                 When T32_TERM_MEMORY_BLOCKED_SIZE is not set the function T32_Term_Memory_SetBuffer should be called from user code.
	  ...
	  other sources files:
	    t32term_memory.c           : required for T32_TERM_METHOD_MEMORY
...
#	define T32_TERM_OSEXEC_MODE_WINDOW 0
#	define T32_TERM_OSEXEC_MODE_HIDDEN 1
#	define T32_TERM_OSEXEC_MODE_AREA   2
